...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full h-20 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-lg z-50">
      <div
        className="absolute top-0 left-0 h-1 bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400"
      ...
      <div className="max-w-7xl mx-auto px-4 h-full">
        <div className="flex justify-between items-center h-full">
          <div className="flex-shrink-0 flex items-center">
            <a
              href="#home"
              className="text-2xl font-bold text-indigo-400 dark:text-indigo-400"
            >
              Pervin
            </a>
          </div>
