  ...
  const certifications: Certification[] = [
    {
      ...
      date: "2023",
      description:
        "La certification Responsive Web Design de FreeCodeCamp forme aux bases du HTML5, du CSS3 et aux techniques de design adaptatif, permettant de créer des sites web modernes et optimisés pour tous types d'écrans.",
      image:
    ...
    },
    {
      ...
      date: "2023",
      description:
        "Le MOOC de l'ANSSI permet de sensibiliser à la cybersécurité et de fournir les clés pour protéger ses données et systèmes contre les cyberattaques.",
    ...
    },
    {
      ...
      date: "2024",
      description:
        "La certification English for IT 1 de Cisco améliore les compétences en anglais pour mieux comprendre le vocabulaire et les termes techniques de l'informatique.",
      image:
    ...
    },
    {
      ...
      date: "2024",
      description:
        "La certification Introcution à cybersécurité de Cisco permet une introduction en douceur des différents concepts liés à la cybersécurité ainsi qu'aux enjeux de celle-ci.",
      image:
        "https://translatorswithoutborders.org/wp-content/uploads/2021/12/Cisco-logo.png",
    ...
    },
    {
      ...
      date: "2024",
      description:
        "La certification Découverte de Linux de Cisco permet un apprentissage des bases du système d'exploitation de Linux, permettant une utilisation complète de cet OS.",
      image:
        "https://translatorswithoutborders.org/wp-content/uploads/2021/12/Cisco-logo.png",
    ...
    },
    {
      ...
      date: "2024",
      description:
        "La certification Networking Essentials de Cisco permet de comprendre les bases du Networking en assurant que ces bases puissent-être utilisé dans un contexte professionel.",
      image:
        "https://translatorswithoutborders.org/wp-content/uploads/2021/12/Cisco-logo.png",
    ...
    },
    {
      ...
      date: "2025",
      description:
        "La certification JavaScript Algorithms and Data Structures de freeCodeCamp permet d'assimiler les bases de JavaScript tout en les approfondissant dans la même certification.",
      image:
        "https://design-style-guide.freecodecamp.org/img/fcc_secondary_small.svg",
    },
  ];
